        ...
        <div class="col">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    -->
                    <td>
                        <button class="btn btn-primary" onclick="location.href='/update?id=${student.id}'">수정</button>
                    </td>
                    <td>
                        <button class="btn btn-danger" onclick="location.href='/delete?id=${student.id}'" >삭제</button>
                    </td>
                </tr>
                </c:forEach>
            </table>
